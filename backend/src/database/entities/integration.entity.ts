...
export class Integration {
         ...
         @Column({ type: 'enum', enum: IntegrationProviderEnum, nullable: false })
         provider: IntegrationProviderEnum;

         @Column({ type: 'enum', enum: IntegrationCategoryEnum, nullable: false })
         category: IntegrationCategoryEnum;

         @Column({ type: 'enum', enum: IntegrationAppTypeEnum, nullable: false })
