...
import { checkIntegrationService, connectAppService, createIntegrationService, getUserIntegrationsService } from "../services/integration.service";
...
import { IntegrationAppTypeEnum, IntegrationCategoryEnum, IntegrationProviderEnum } from "../database/entities/integration.entity";
...
export const checkIntegrationController = asyncHandleAndValidate(
  AppTypeDTO,
  "params",
...
export const connectAppController = asyncHandleAndValidate(
  AppTypeDTO,
  "params",
  async (req: Request, res: Response, appTypeDto) => {
    const userId = req.user?.id as string;
